      ...
      child: ListView(
        ...
        children: [
          ...
          for (final h in stats.perHostel) ...[
            _OccupancyRow(h: h, onTap: () => context.push('/hostel/${h.id}')),
            const SizedBox(height: RoostSpacing.md),
          ],
        ],
      ),
...
class _OccupancyRow extends StatelessWidget {
  const _OccupancyRow({required this.h, required this.onTap});
  ...
  Widget build(BuildContext context) {
    ...
    return Semantics(
      button: true,
      label: 'View rooms and beds in ${h.name}',
      child: RoostSurfaceCard(
        floating: true,
        onTap: onTap,
        padding: const EdgeInsets.all(RoostSpacing.lg),
            ...
            ClipRRect(
              ...
              child: LinearProgressIndicator(
                ...
                valueColor: AlwaysStoppedAnimation(
                  pct > 90 ? RoostColors.negative : RoostColors.accent,
                ),
              ),
            ),
          ],
